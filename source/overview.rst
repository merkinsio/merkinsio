...
* **Support for prompts and statuslines in many applications.** Originally
  ...
  other applications that Merkins.io doesn’t yet support.
* **Configuration and colorschemes written in JSON.** JSON is
  ...
  user configuration across all of Merkins.io’s supported applications.
...
hassle for me / what happened to the original vim-Merkins.io project / …*

You should check out some of the Merkins.io derivatives. The most lightweight
